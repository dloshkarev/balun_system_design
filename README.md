...
- Распределить данные по нескольким датацентрам (репликам), расположенным в разных частях мира
...
3. Реплицировать все. Останавливаемся на этом варианте, как наиболее надежном. В итоге реплицируем как холодные, так и горячие данные
